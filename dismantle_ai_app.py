...
def get_s3_analysis_history():
    ...
    try:
        ...
        response = s3.list_objects_v2(Bucket="brandbyme1", Prefix="scraped-data/")
...
def main():
    ...
    with st.sidebar:
        logo_path = r"C:\Users\chido\Desktop\Anti-racism Brand Auditing Tool\logo\Dismantle AI.png"
        try:
    ...
    with tabs[1]:
        ...
        if history:
            ...
            if selected_analysis:
                try:
                    s3 = boto3.client('s3', region_name=REGION)
                    obj = s3.get_object(Bucket="brandbyme1", Key=selected_analysis)
